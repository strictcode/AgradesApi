...
public class StudentRecordDetail
{
    [JsonProperty("id")]
    ...
    [JsonProperty("class")]
    public string YearDotClass { get; set; } = null!;
}
...
public static class PersonDetailModelExtenstions
{
    ...
    public static StudentRecordDetail ToDetail(this IAppMapper mapper, PersonDetail source)
        => new()
        {
            Id = source.Id,
